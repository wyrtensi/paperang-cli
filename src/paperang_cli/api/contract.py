...
P2_API_CONTRACT = {
    ...
    "constructor_options": [
        ...
        },
        {
            ...
            "type": "int | None",
            "default": None,
            "description": "Optional override for the printer render width. P2 defaults to 576 pixels.",
        },
        {
            "name": "print_density",
            "type": "int | None",
        ...
        },
        {
            ...
            "type": "list[str] | None",
            "default": None,
            "description": "Optional list of BLE advertising names to scan for when transport='ble'.",
        },
    ],
    "methods": [
        {
    ...
    "safety": {
        ...
        "notes": [
            "Real printing still flows through the existing driver and safety checks.",
            "Dry-run results include the resolved styling object used for the job.",
            "Image and compose printing remain experimental until validated on real hardware.",
        ],
    },
    "styling_support": {
    ...
    "unsupported_parity_gaps": [
        "P2-specific upstream extras such as QR printing, pickup-code printing, and profile-specific commands are not part of this public facade yet.",
        "Rotated compose printing is not implemented yet; compose remains an ordinary vertical layout in this release.",
        "Physical P2 USB/BLE validation has not been completed in this repository yet.",
        "The public Python API intentionally does not expose a stable low-level packet or transport contract.",
    ],
}
